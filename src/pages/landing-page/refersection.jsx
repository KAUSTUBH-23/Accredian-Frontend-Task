...
// import backgroundImage from "../../assets/image2.PNG"; // Ensure this is the correct path
...
export default function ReferSection({ data }) {
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-5">How do I <span className="text-primary">Refer?</span></h2>
      <div className="relative w-full h-64" /> {/* Placeholder for background image */}
      <div className="mt-10">
        <ReferButton />
      </div>
    </section>
